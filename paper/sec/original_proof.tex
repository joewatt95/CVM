...
To see how tail bounds can be derived from this inequality, note that it is possible to union bound the probability that the estimate exceeds the desired interval, with the probability of the event in conjunction with specific values $k = K$.
