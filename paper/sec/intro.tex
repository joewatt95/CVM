...
\item formalization of a library for negative association (\cref{sec:negdep}); and %in the directory Negative{\textunderscore}Association, which we intend to submit to the AFP as a separate contribution.
\item formalization of CVM following the original proof by Chakraborty et al.~\cite{chakraborty2022,chakraborty2023} (\cref{sec:transformation_based_proof}).
\end{itemize}
