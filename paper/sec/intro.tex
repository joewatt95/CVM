...
More interestingly, the resulting variant is \emph{unbiased}, i.e., the expected value returned by the algorithm is exactly the cardinality of the elements in the stream; this is a new property that neither the original CVM algorithm nor classic algorithms for the distinct elements problem possess.
