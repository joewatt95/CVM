...
\item formalization~\cite{Negative_Association-AFP} of a library for negative association; and %in the directory Negative{\textunderscore}Association, which we intend to submit to the AFP as a separate contribution.
