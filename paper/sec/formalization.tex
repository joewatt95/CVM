...
The file CVM{\textunderscore}Abstract{\textunderscore}Algorithm verifies a generalized version of the CVM algorithm, wiht an abstract subsampling operation, which is required to fullfill \cref{eq:subsample_condition}.
