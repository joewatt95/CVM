...
In the formalization, we use different conditions for introduction vs. elimination rules.
In paritcular, for introduction rules, the test functions are bounded and measurable.
