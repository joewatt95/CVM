...
\end{equation}
for all non-negative functions $g$ and any $S \subset \chi$---any subsampling step that satisfies this functional inequality can be used while still preserving~\cref{i:func_invariant} for the algorithm.
