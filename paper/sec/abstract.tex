...
In this paper, we introduce the proof technique, describe its use in Isabelle/HOL to mechanize both versions of the CVM algorithm, and present a supporting formalized library on negative association used to verify the latter variant.
\end{abstract}
