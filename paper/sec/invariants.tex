...
As a simpler concrete example, consider choosing $S = \{s\}$ for any element $s \in A$.
...
\end{align*}
This implies the simple invariant $\expect \left[ p^{-1} X_s \right] = 1$ without needing a separate induction over the algorithm.
