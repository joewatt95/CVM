...
%TODO: should we use exp(...) everywhere instead of mixing with e^ ? EK: That was the previous verison, main issue is the chain looks very lopsided, with almost all of the terms being on the right edge. (It looked too ugly.)
