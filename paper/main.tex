...
\authorrunning{E. Karayel, S. J. Watt, D. Khu, K. S. Meel, Y. K. Tan} %TODO mandatory. First: Use abbreviated first/middle names. Second (only in severe cases): Use first author plus 'et al.'

\Copyright{Emin Karayel, Seng Joe Watt, Derek Khu, Kuldeep S. Meel, Yong Kiam Tan} %TODO mandatory, please use full first names. LIPIcs license is "CC-BY";  http://creativecommons.org/licenses/by/3.0/
...
\supplementdetails[cite=CVM_Transforms-Github, swhid=swh:1:dir:c677f1e3ced670373c05ac835f1cd342a2777e20]{Software}{https://github.com/joewatt95/CVM/tree/main/isabelle/CVM_Transforms}
