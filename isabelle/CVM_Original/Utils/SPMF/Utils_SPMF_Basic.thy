...
(* Isabelle2025:
adhoc_overloading kleisli_compose_right \<rightleftharpoons> \<open>\<lambda> f g x. bind_spmf (f x) g\<close> *)
adhoc_overloading kleisli_compose_right \<open>\<lambda> f g x. bind_spmf (f x) g\<close>
